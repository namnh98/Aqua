...
const ScalableImage = (props) => {
   const ImageComponent = props.component ? props.component : props.background ? ImageBackground : Image; //background image hoặc image thường
   ...
   const onProps = (localProps) => {
      ...
      if (source.uri) {
         ...
         Image.getSize(sourceToUse, (width, height) => adjustSize(width, height, props), console.err);
      } else {
