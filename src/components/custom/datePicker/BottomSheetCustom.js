   ...
   return (
      <View>
         ...
         <Modal
            ...
            <View style={[styles.content, props.containerStyle, { height: '100%' }]}>
               <TouchableWithoutFeedback onPress={() => onClose()}>
                  <View
                     style={{
                        width: '100%',
               ...
               <Animated.View
                  style={{
                     width: '100%',
                     height:
                        maxHeight - keyboardHeight > Sizes.s340 ? maxHeight - keyboardHeight : maxHeight + Sizes.s20,
                     ...
                     <View
                        ...
                        <TouchableOpacity
                           ...
                           {props.rightIcon ? (
                              ...
                              <Image
                                 source={require('../../../res/image/ic_cancel.png')}
                                 style={{
                                    width: Sizes.s30,
                                    height: Sizes.s30,
                                    resizeMode: 'contain',
